...
Find definitions of I-ADOPT-specific concepts in the [I-ADOPT ontology](https://i-adopt.github.io/ontology/) and some specific terms used in the design guide in this [glossary](https://github.com/mabablue/I-ADOPT-patterns-playground/blob/main/Guide/glossary.md). 
